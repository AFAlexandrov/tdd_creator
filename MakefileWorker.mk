...
# This file start it's path from here:
# https://github.com/jwgrenning/tddec-code/blob/master/code/unity.framework/extras/fixture/build/MakefileWorker.mk
...
ifeq ($(UNITY_USE_MEM_LEAK_DETECTION), N)
	...
	UNITY_MEMLEAK_DETECTOR_MALLOC_MACRO_FILE = -include $(UNITY_HOME)/extras/memory/src/unity_memory.h
endif
